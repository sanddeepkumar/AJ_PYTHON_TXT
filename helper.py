...
async def send_vid(bot: Client, m: Message, cc, filename, thumb, name,thumb2):
    ...
    try:
        await m.reply_video(filename, caption=cc, supports_streaming=True, height=1080, width=1920, thumb=thumbnail, duration=dur, progress=progress_bar, progress_args=(reply, start_time))
    except Exception:
